...
const Navbar = () => {
    ...
    return (
        <div className="py-5  bg-white ">
            <div className="md:px-20 px-4 sm:px-10  relative flex items-center justify-between">
                <Link
                    to="/"
                ...
                <ul className="items-center hidden space-x-8 lg:flex">
                    ...
                    <li>
                        <div className="dropdown dropdown-end">
                            ...
                            <ul
                                tabIndex={0}
                                className="menu bg-white dropdown-content p-2 shadow rounded-box w-52 mt-4 "
                            >
                                {/* <li>
                                    <Link
                                        to="/login"
